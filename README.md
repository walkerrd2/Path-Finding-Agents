Objective:
The main goal is to design, implement, and test various pathfinding/searching agents. The project aims to visualize the paths produced by different search strategies and understand the complexity of these methods by examining the states explored and the resulting search tree.
